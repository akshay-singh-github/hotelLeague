...
(function () {
    ...
    function hotelInformationController($route, $location,$window,$sce, userService,bookingService,hotelService,reviewService, currentUser,googleService,$routeParams) {
        var model = this;
