/**
 * Created by XA on 10-Aug-17.
 */

(function () {
    angular.module("HotelLeagueMaker")
        .controller("hotelInformationController", hotelInformationController);

    function hotelInformationController($route, $location,messageService,$window,$sce, userService,bookingService,hotelService,reviewService, currentUser,googleService,$routeParams) {
        var model = this;
